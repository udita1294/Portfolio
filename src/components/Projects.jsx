            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute top-4 right-4">
                  <span className="px-3 py-1 rounded-lg bg-amber-500/95 backdrop-blur-sm text-white text-sm font-semibold shadow-md">
                    {project.year}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <p className="text-amber-700 font-semibold mb-3">{project.subtitle}</p>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-semibold transition-colors shadow-md shadow-amber-200/40"
                >
